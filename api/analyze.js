...
export const config = {
  api: {
    bodyParser: {
      sizeLimit: '10mb', // Increased to support higher res images
    },
  },
};
...
- The images may contain handwritten Chinese and English.
- Pay close attention to details like time, symptoms before the fall, and environmental factors mentioned in the text.
- If text is small, look for context clues to accurately identify nursing home terminology.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    parts.push({
      text: "Analyze these images in high detail. If they are documents, perform careful OCR to extract all relevant medical and incident details. Return result in Traditional Chinese.",
    });
